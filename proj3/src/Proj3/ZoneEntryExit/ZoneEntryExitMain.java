...
public class ZoneEntryExitMain {
    ...
    public static void main(String[] args) {
        ...
        ZoneEntryExitInterface monitorStub = null;
        ...
        try {
            a = (GeneralPass) registry.lookup(configInfo.getzGen());
        } catch (RemoteException e) {
        ...
        // Create monitor
        try {
            monitor = new ZoneEntryExit(configInfo.getnP(), a);
        } catch (RemoteException e) {
        ...
        try {
            monitorStub = (ZoneEntryExitInterface) UnicastRemoteObject.exportObject(monitor, configInfo.getzEEPort());
        } catch (RemoteException e) {
        ...
        try {
            reg.bind(configInfo.getzEE(), monitorStub);
        } catch (RemoteException e) {
