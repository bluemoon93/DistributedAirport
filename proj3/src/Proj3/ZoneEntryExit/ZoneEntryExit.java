 ...
 */
public class ZoneEntryExit implements ZoneEntryExitInterface {
     ...
     */
    @Override
    public synchronized void goingHome(int id) throws RemoteException {
    ...
    @Override
    public final void restart(int nPass, GeneralPass g){
