...
public class GUI extends javax.swing.JFrame {
    ...
    private JPanel[] passageiros, lugares, bags;
    private int [] currBags, maxBags;
    private List bagOwners; 
    private JPanel driver, driver2, plane, porter;
    private boolean swiftSimulation;
    private JLabel storage, lost, left;
    ...
    public void setMalas(int fn, int ln) {
        ...
        if (fn == -1) {
            this.setLocation(plane, landingStrip, 400, -200);
    ...
    public void restart(int nPass, int nLug, boolean swift){
