...
public class GeneralMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralInterface monitorStub = null;
        ...
        // Create monitor
        try {
            monitor = new General (configInfo.getnP(), configInfo.getnL(), configInfo.getLogName());
        } catch (IOException ex) {
            System.out.println("Monitor instantiation gone wrong: " + ex.getMessage());
            ex.printStackTrace();
            System.exit(1);
        }
        ...
        try {
            monitorStub = (GeneralInterface) UnicastRemoteObject.exportObject(monitor, configInfo.getzGenPort());
        } catch (RemoteException e) {
        ...
        try {
            reg.bind(configInfo.getzGen(), monitorStub);
        } catch (RemoteException e) {
