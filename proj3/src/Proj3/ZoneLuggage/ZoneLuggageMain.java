...
public class ZoneLuggageMain {
    ...
    public static void main(String[] args) {
        ...
        ZoneLuggageInterface monitorStub = null;
        ...
        GeneralLuggage a = null;

        try {
            a = (GeneralLuggage) registry.lookup(configInfo.getzGen());
        } catch (RemoteException e) {
        ...
        // Create monitor
        try{
        monitor = new ZoneLuggage(a, configInfo.getnP());
        } catch (RemoteException e) {
        ...
        try {
            monitorStub = (ZoneLuggageInterface) UnicastRemoteObject.exportObject(monitor, configInfo.getzLugPort());
        } catch (RemoteException e) {
        ...
        try {
            reg.bind(configInfo.getzLug(), monitorStub);
        } catch (RemoteException e) {
