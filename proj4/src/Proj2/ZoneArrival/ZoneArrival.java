...
import Proj2.ZoneArrival.Interfaces.*;
 ...
 */
public class ZoneArrival implements ZoneArrivalPass, ZoneArrivalPorter, ZoneArrivalPlane {
     ...
     */
    @Override
    public synchronized boolean takeArest(int reqId) {
     ...
     */
    @Override
    public synchronized int getLugNumber(int reqId) {
        // Return how many bags are still left in the plane's hold
     ...
     */
    @Override
    public synchronized Luggage getLug(int reqId) {
     ...
     * @param nPass number of passengers per plane
     */
    protected final synchronized void restart(int nAv, int nPass) {
        this.nAvioes = nAv;
